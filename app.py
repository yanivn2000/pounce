            ...
            if not _pl_rows:
                ...
                for _r in _pl_rows:
                    ...
                    _tbl_rows.append({
                        ...
                        "Unit Price":      round(_prod_price + _svc_price, 2),
                        "Total Prod Cost": round(_r["total_mfg"] or 0, 2),
                        "Total Svc Cost":  round(_r["total_svc"] or 0, 2),
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "Unit Price":      st.column_config.NumberColumn("Unit Price",      format="$%.2f", width=95,
                                              help="Prod Price + Svc Price per unit"),
                        "Total Prod Cost": st.column_config.NumberColumn("Total Prod Cost", format="$%.2f", width=115,
                                              help="Prod Price × Qty"),
                        "Total Svc Cost":  st.column_config.NumberColumn("Total Svc Cost",  format="$%.2f", width=110,
                                              help="Svc Price × Qty"),
                        "Total Unit Cost": st.column_config.NumberColumn("Total Unit Cost", format="$%.2f", width=115,
                                              help="Total Prod + Total Svc"),
